...
The Hammerspoon 2 project has strict rules for AI usage:
...
Please remember that Hammerspoon 2 is maintained by humans.
...
Hammerspoon 2 is written with plenty of AI assistance, and many maintainers
embrace AI tools as a productive tool in their workflow. As a project,
we welcome AI as a tool!

## Policy origin

This is somewhat based on the AI Policy used by Ghostty.
